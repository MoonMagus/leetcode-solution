...
private:
    ...
    bool isAnagram(vector<int>& count_a, vector<int>& count_b) {
...
public:
    vector<int> findAnagrams(string s, string p) {
        ...
        vector<int> count_a(ASCII, 0);
        vector<int> count_b(ASCII, 0);
        for (int i = 0; i < lp; ++i) {
            count_a[p[i]]++;
            count_b[s[i]]++;
        }
...
int main() {
    ...
    Solution so;
    vector<int> result = so.findAnagrams("abab", "ab");
