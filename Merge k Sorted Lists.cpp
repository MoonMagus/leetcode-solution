...
public:
    ...
    ListNode* merge(vector<ListNode*>::iterator start, vector<ListNode*>::iterator end) {
        if (start >= end)
            return NULL;
        ...
        ListNode* l1 = merge(start, next(start, n / 2 + 1));
        ListNode* l2 = merge(next(start, n / 2 + 1), end);
